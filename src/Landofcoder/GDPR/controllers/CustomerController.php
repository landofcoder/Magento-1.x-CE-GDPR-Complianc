<?php
class Landofcoder_GDPR_CustomerController extends Mage_Core_Controller_Front_Action
{
    ...
    public function deleteaccountAction() {
        ...
        if (!$customer) {
            Mage::getSingleton('customer/session')->setBeforeAuthUrl(Mage::getUrl('landofcoder_gdpr/customer/deleteaccount'));
            $this->_redirect('customer/account/login');
            return;
        }
        ...
        $successMessage = Mage::helper('landofcoder_gdpr')->getSuccessMessage();
